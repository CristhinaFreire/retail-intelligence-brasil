...
# Notebook.......: 08_bronze_microrregioes
# Camada.........: Bronze
# Fonte..........: IBGE - API Localidades
# Objetivo.......: Persistir microrregiões do IBGE na Bronze
...
TABLE_NAME = "ibge_microrregioes_raw"
...
VOLUME_PATH = (
    ...
    f"ibge/localidades/microrregioes/{CURRENT_DATE}"
)

FILE_NAME = f"microrregioes_{CURRENT_TIME}.json"

FILE_PATH = f"{VOLUME_PATH}/{FILE_NAME}"

print("=" * 60)
print("BRONZE - IBGE MICRORREGIÕES")
print("=" * 60)
...
print(f"Microrregiões encontradas: {len(landing_data)}")
