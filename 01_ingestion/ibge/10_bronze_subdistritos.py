...
# Notebook.......: 10_bronze_subdistritos
# Camada.........: Bronze
# Fonte..........: IBGE - API Localidades
# Objetivo.......: Persistir subdistritos do IBGE na Bronze
...
TABLE_NAME = "ibge_subdistritos_raw"
...
VOLUME_PATH = (
    ...
    f"ibge/localidades/subdistritos/{CURRENT_DATE}"
)

FILE_NAME = f"subdistritos_{CURRENT_TIME}.json"

FILE_PATH = f"{VOLUME_PATH}/{FILE_NAME}"

print("=" * 60)
print("BRONZE - IBGE SUBDISTRITOS")
print("=" * 60)
...
print(f"Subdistritos encontrados: {len(landing_data)}")
