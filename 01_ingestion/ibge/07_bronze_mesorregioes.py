...
# Notebook.......: 07_bronze_mesorregioes
# Camada.........: Bronze
# Fonte..........: IBGE - API Localidades
# Objetivo.......: Persistir mesorregiões do IBGE na Bronze
...
TABLE_NAME = "ibge_mesorregioes_raw"
...
VOLUME_PATH = (
    ...
    f"ibge/localidades/mesorregioes/{CURRENT_DATE}"
)

FILE_NAME = f"mesorregioes_{CURRENT_TIME}.json"

FILE_PATH = f"{VOLUME_PATH}/{FILE_NAME}"

print("=" * 60)
print("BRONZE - IBGE MESORREGIÕES")
print("=" * 60)
...
print(f"Mesorregiões encontradas: {len(landing_data)}")
