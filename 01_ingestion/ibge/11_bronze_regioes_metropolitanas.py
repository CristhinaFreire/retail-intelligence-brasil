...
# Notebook.......: 11_bronze_regioes_metropolitanas
# Camada.........: Bronze
# Fonte..........: IBGE - API Localidades
# Objetivo.......: Persistir regiões metropolitanas do IBGE na Bronze
...
TABLE_NAME = "ibge_regioes_metropolitanas_raw"
...
VOLUME_PATH = (
    ...
    f"ibge/localidades/regioes_metropolitanas/{CURRENT_DATE}"
)

FILE_NAME = f"regioes_metropolitanas_{CURRENT_TIME}.json"

FILE_PATH = f"{VOLUME_PATH}/{FILE_NAME}"

print("=" * 60)
print("BRONZE - IBGE REGIÕES METROPOLITANAS")
print("=" * 60)
...
print(f"Regiões metropolitanas encontradas: {len(landing_data)}")
