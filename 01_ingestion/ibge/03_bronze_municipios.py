...
# Notebook.......: 03_bronze_municipios
# Camada.........: Bronze
# Fonte..........: IBGE - API Localidades
# Objetivo.......: Persistir municípios do IBGE na Bronze
...
TABLE_NAME = "ibge_municipios_raw"
...
VOLUME_PATH = (
    ...
    f"ibge/municipios/{CURRENT_DATE}"
)

FILE_NAME = f"municipios_{CURRENT_TIME}.json"

FILE_PATH = f"{VOLUME_PATH}/{FILE_NAME}"

print("=" * 60)
print("BRONZE - IBGE MUNICÍPIOS")
print("=" * 60)
...
print(f"Municípios encontrados: {len(landing_data)}")
