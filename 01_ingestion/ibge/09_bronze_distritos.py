...
# Notebook.......: 09_bronze_distritos
# Camada.........: Bronze
# Fonte..........: IBGE - API Localidades
# Objetivo.......: Persistir distritos do IBGE na Bronze
...
VOLUME_PATH = (
    ...
    f"ibge/localidades/distritos/{CURRENT_DATE}"
)

FILE_NAME = f"distritos_{CURRENT_TIME}.json"

FILE_PATH = f"{VOLUME_PATH}/{FILE_NAME}"

print("=" * 60)
print("BRONZE - IBGE DISTRITOS")
print("=" * 60)
...
print(f"Distritos encontrados: {len(landing_data)}")
